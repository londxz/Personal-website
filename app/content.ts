...
export const content: Record<Language, SiteContent> = {
  en: {
    ...
    hero: {
      ...
      experienceCta: "Work experience",
      cv: "Download CV",
      nowLabel: "Now",
      nowValue: "Yandex · iOS",
      ownProjectsLabel: "My products",
  ...
  ru: {
    nav: [
      ...
      { id: "projects", label: "Мои продукты" },
    ...
    hero: {
      ...
      experienceCta: "Опыт работы",
      cv: "Скачать резюме",
      nowLabel: "Сейчас",
      nowValue: "Яндекс · iOS",
      ownProjectsLabel: "Мои продукты",
